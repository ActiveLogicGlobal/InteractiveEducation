...
public class FacultyFeedback implements KeyListener , MouseListener, ActionListener ,WindowListener
{JLabel err1;
    Connection conn;
JFrame f;
JPanel p;//,pfeed;
...
SimpleDateFormat ft;
    ...
    FacultyFeedback(String s,String u)
    {
	...
	l.setForeground(new Color(0,0,153));
        ...
        b=new JLabel(new ImageIcon("C:\\Users\\gurvishal\\Documents\\NetBeansProjects\\KnowledgePoint\\src\\knowledgepoint\\pictures\\ppp.png"));
	...
	l.setBounds(100,30,200,30);        
        logout.setBounds (400,50,105,36);
...
@Override
        public void actionPerformed (ActionEvent e)
        {
            ...
            if(o==bck)
            {
                FacultyFeedback sf=new FacultyFeedback(tname.getText(),uid.getText());
                f.setVisible(false);
            }
        }
}
