...
public class AdminFeedback extends JFrame implements MouseListener ,ActionListener ,KeyListener , FocusListener,WindowListener
{
    ...
    JFrame f;    
    JPanel p,pa;
    JLabel lpic,la,l ,areply,qno[],dt ,count,sname[],sid[],stname,stid,sask,stask[];
    JTextArea a;
    JButton asubmit, areset ,acancel , reply[] ,logout,back;
...
//   System.out.println ("after teacher login name =="+n);
    ...
    l=new JLabel("Feedbacks");    l.setFont(new Font("Times New Roman",0,35));l.setForeground(new Color(0,0,153));
    la=new JLabel("Unanswered Feedbacks");    la.setFont(new Font("Tahoma",0,25));
    ...
    back.setBounds(1100,65,88,28);                              back.setBorder(BorderFactory.createEmptyBorder());
    ...
    lpic.add(back);back.addActionListener((ActionListener)this);back.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
    lpic.add(la);
    ...
    @Override
     ...
     if(o==asubmit)
     {
                     try
                     {
                         ...
                         ps=c.conn.prepareStatement("insert into adminfeed values(?,?,?,?,?)");
                            ps.setString(1, stid.getText().toString());
                            ps.setString(2, stname.getText().toString());
                            ps.setString (3,at.getText().toString());
                            ps.setString (4,a.getText().toString());
                            ps.setString (5,dt.getText().toString());
                    //        ps.setString (6,stid.getText().toString());
                            ps1=c.conn.prepareStatement("delete  from feedback where fdbck=?");
